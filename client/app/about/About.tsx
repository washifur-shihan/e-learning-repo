  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Rookie Academy?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Rookie Academy, the premier programming community dedicated
          ...
          That&apos;s why Rookie Academy is Here &ndash; to provide new programmers
          ...
          <br />
          <br />
          At Rookie Academy, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          Rookie Academy is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Rookie Academy by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Rookie Academy today and let&apos;s
